...
Json::Value CartPole::toJson() const
{
  v["max_pos"           ] =  max_pos               , out);
  v["max_vel"           ] =  max_vel               , out);
  v["max_torque"        ] =  max_torque            , out);
  v["max_axis_vel"      ] =  max_axis_vel          , out);
  v["start_cart_pos_tol"] =  start_cart_pos_tol    , out);
  v["start_cart_vel_tol"] =  start_cart_vel_tol    , out);
  v["start_axis_pos_tol"] =  start_axis_pos_tol    , out);
  v["start_axis_vel_tol"] =  start_axis_vel_tol    , out);
  rhoban_utils::xml_tools::write<std::string>("reward_type  ", to_string(reward_type), out);
}

void CartPole::fromJson(const Json::Value & v, const std::string & dir_name)
{
  ...
  rhoban_utils::tryRead(v, "start_cart_pos_tol", start_cart_pos_tol);
  rhoban_utils::tryRead(v, "start_cart_vel_tol", start_cart_vel_tol);
  rhoban_utils::tryRead(v, "start_axis_pos_tol", start_axis_pos_tol);
  rhoban_utils::tryRead(v, "start_axis_vel_tol", start_axis_vel_tol);
