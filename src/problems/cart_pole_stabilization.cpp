...
CartPoleStabilization::CartPoleStabilization() : learning_space(LearningSpace::Angular)
{
...
double CartPoleStabilization::getReward(const Eigen::VectorXd& action, const Eigen::VectorXd& result) const
{
...
Problem::Result CartPoleStabilization::getSuccessor(const Eigen::VectorXd& state, const Eigen::VectorXd& action,
...
Eigen::VectorXd CartPoleStabilization::getFullSuccessor(const Eigen::VectorXd& state, const Eigen::VectorXd& action,
                                                        std::default_random_engine* engine) const
{
  ...
  while (elapsed < simulation_step)
  {
    ...
    double acc = (g * sin(th) - alpha * pendulum_mass * pendulum_length * dt_th2 * sin(2 * th) / 2 -
...
Eigen::VectorXd CartPoleStabilization::getAngularSuccessor(const Eigen::VectorXd& state, const Eigen::VectorXd& action,
                                                           std::default_random_engine* engine) const
{
...
CartPoleStabilization::LearningSpace CartPoleStabilization::detectSpace(const Eigen::VectorXd& state) const
{
...
CartPoleStabilization::LearningSpace CartPoleStabilization::loadLearningSpace(const std::string& str)
{
  if (str == "Angular")
  {
  ...
  throw std::runtime_error("CartPoleStabilization::loadLearningSpace: unknown learning space: '" + str + "'");
}
...
std::string to_string(CartPoleStabilization::LearningSpace learning_space)
{
  switch (learning_space)
  {
    case CartPoleStabilization::LearningSpace::Angular:
      return "Angular";
    case CartPoleStabilization::LearningSpace::Cartesian:
      return "Cartesian";
    case CartPoleStabilization::LearningSpace::Full:
      return "Full";
  }
